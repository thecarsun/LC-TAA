...
"C:\Program Files (x86)\Microsoft Visual Studio\Shared\Python39_64\python.exe" "C:\Users\Car\grepos\LC-TAA\src\scrape_tracker.py" >> C:\Users\Car\grepos\LC-TAA\update_log.txt 2>&1
