...
"C:\Users\Car\AppData\Local\Python\pythoncore-3.14-64\python.exe" "C:\Users\Car\grepos\LC-TAA\src\scrape_tracker.py" >> C:\Users\Car\grepos\LC-TAA\update_log.txt 2>&1
